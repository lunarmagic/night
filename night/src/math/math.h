...
namespace night
{
	...
	vec2 NIGHT_API project_point_to_plane(const vec2& point, const vec2& plane_origin, const vec2& plane_normal);
	...
	DistanceToLineResult NIGHT_API distance_to_plane(const vec2& line_a, const vec2& line_b, const vec2& point);
}